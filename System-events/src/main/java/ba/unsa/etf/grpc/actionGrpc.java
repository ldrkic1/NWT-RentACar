...
public final class actionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ba.unsa.etf.grpc.SystemEventsRequest,
      ba.unsa.etf.grpc.SystemEventResponse> getLogActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logAction",
      requestType = ba.unsa.etf.grpc.SystemEventsRequest.class,
      responseType = ba.unsa.etf.grpc.SystemEventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ba.unsa.etf.grpc.SystemEventsRequest,
      ba.unsa.etf.grpc.SystemEventResponse> getLogActionMethod() {
    io.grpc.MethodDescriptor<ba.unsa.etf.grpc.SystemEventsRequest, ba.unsa.etf.grpc.SystemEventResponse> getLogActionMethod;
      ...
      synchronized (actionGrpc.class) {
        if ((getLogActionMethod = actionGrpc.getLogActionMethod) == null) {
          actionGrpc.getLogActionMethod = getLogActionMethod = 
              io.grpc.MethodDescriptor.<ba.unsa.etf.grpc.SystemEventsRequest, ba.unsa.etf.grpc.SystemEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "action", "logAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.unsa.etf.grpc.SystemEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ba.unsa.etf.grpc.SystemEventResponse.getDefaultInstance()))
  ...
  public static abstract class actionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logAction(ba.unsa.etf.grpc.SystemEventsRequest request,
        io.grpc.stub.StreamObserver<ba.unsa.etf.grpc.SystemEventResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ba.unsa.etf.grpc.SystemEventsRequest,
                ba.unsa.etf.grpc.SystemEventResponse>(
  ...
  public static final class actionBlockingStub extends io.grpc.stub.AbstractStub<actionBlockingStub> {
    ...
    /**
     */
    public ba.unsa.etf.grpc.SystemEventResponse logAction(ba.unsa.etf.grpc.SystemEventsRequest request) {
  ...
  public static final class actionFutureStub extends io.grpc.stub.AbstractStub<actionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ba.unsa.etf.grpc.SystemEventResponse> logAction(
        ba.unsa.etf.grpc.SystemEventsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG_ACTION:
          serviceImpl.logAction((ba.unsa.etf.grpc.SystemEventsRequest) request,
              (io.grpc.stub.StreamObserver<ba.unsa.etf.grpc.SystemEventResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class actionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ba.unsa.etf.grpc.SystemEvent.getDescriptor();
    }
